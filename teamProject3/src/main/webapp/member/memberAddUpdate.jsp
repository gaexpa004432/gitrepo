...
<form method="post" action="/teamProject3/addUpdate.do">
	...
	<div>
		<label>주소</label><br>
		<input type="text" name="seller_postcode" id="sample4_postcode" placeholder="우편번호" value="${sessionScope.login.seller_postcode}">
		<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
		<input type="text" name="seller_roadAddress" id="sample4_roadAddress" placeholder="도로명주소" value="${sessionScope.login.seller_roadAddress}">
		<input type="hidden" name="seller_jibunAddress" id="sample4_jibunAddress" placeholder="지번주소">
		<span id="guide" style="color:#999;display:none"></span>
		<input type="text" name="seller_detailAddress" id="sample4_detailAddress" placeholder="상세주소" value="${sessionScope.login.seller_detailAddress}">
		<input type="text" name="seller_extraAddress" id="sample4_extraAddress" placeholder="참고항목" value="${sessionScope.login.seller_extraAddress}">
	</div>
	<div>
		<label>사업장명</label>
