	                        ...
	                        <div class="col-lg-6 col-md-6 col-sm-6">
	                            <div class="blog__item">
	                                <div class="blog__item__pic">
	                                    <figure><img class="a" src="images/${fs.res_pic_name}" alt=""></figure>
	                                </div>
	                                <div class="blog__item__text">
	                                    ...
	                                    <p>${fs.res_content}</p>
	                                    <a href="${pageContext.request.contextPath}/restaurantView.do?res_no=${fs.res_no}" class="blog__btn">식당 자세히보기<span class="arrow_right"></span></a>
	                                </div>
	                            </div>
	                        </div>
                        </c:forEach>
