...
<form name="frm1" action ="recipeInsert.do">
	...
	<textarea name="recipe_content" style="width: 100% rows=" 10" id="recipe_content"
		text-align:center onclick="this.value=''">간단한 소개글을 적어주세요
	</textarea>
	<br>
	<hr>
	<h2>요리 정보</h2>
